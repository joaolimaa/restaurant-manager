...
public class Reserva {
    ...
    public Reserva(Long restauranteId, Long usuarioId, LocalDateTime dataHora, Integer quantidadePessoas, StatusReserva status) {
    ...
    private void realizaValidacoes(Long restauranteId, Long usuarioId, LocalDateTime dataHora, Integer quantidadePessoas, StatusReserva status) {
